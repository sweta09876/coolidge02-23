 ...
 * @author Sweta
 */
public class CoolidgeloginTest {
    
    private WebDriver driver;
    private String baseUrl;
    public CoolidgeloginTest() {
    }
 ...
 //   driver.findElement(By.cssSelector("div.ch-customer-profile-icon > svg > path")).click();
  //  driver.findElement(By.linkText("Logout")).click();
    ...
    driver.findElement(By.name("email")).sendKeys("sweta@pontiffre.com");
    ...
    driver.findElement(By.name("password")).sendKeys("Super945");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
  }
